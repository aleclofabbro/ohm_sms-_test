import type { ModelDescriptor, EntityCollectionDescriptor } from './ohm/types'

export const channelDescriptor: EntityCollectionDescriptor = {
  type: 'array',
  items: {
    type: 'object',
...
const serviceParameterTypeDescriptor: EntityCollectionDescriptor = {
  type: 'array',
  items: {
    type: 'object',
    idProp: { path: 'id' },
